...
const Header: React.FC = () => {
  ...
  // URLs para WhatsApp y Facebook (puedes modificarlas según necesites)
  const whatsappUrl = "https://wa.me/6681688415"; // Reemplaza con tu número
  const facebookUrl = "https://www.facebook.com/alejandro.gonzalezmurguia.3"; // Reemplaza con tu página de Facebook
  ...
  // Handler para clics en WhatsApp
          ...
          {user?.user || session?.user ? (
            ...
            <>
              ...
              <a
                ...
                className="hidden lg:flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors duration-300"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden lg:flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors duration-300"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {user?.user || session?.user ? (
              ...
              <>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors duration-300 w-full justify-center"
                  onClick={() => {
                    handleWhatsAppClick();
                    setNavbarOpen(false);
                  }}
